        ...
        <div className="pb-8 md:pb-26">
            <Container className="flex items-center justify-center gap-8 md:gap-27.75 lg:gap-27.75 md:flex-row flex-col">
                <div className="max-w-134.25 w-full text-center md:text-left">
                    ...
                    >
                        Founded by James and Delmi, J&D Carpet Cleaning was born
                        from years of hands-on experience in the carpet cleaning
                        industry and a shared dream to build a family business
                        that values quality, trust, and community.
                    </Text>
                    ...
                    <div className="flex mt-5 md:mt-8 text-left gap-8 md:gap-6 items-center relative ">
                        ...
                        <div className="pt-1 text-neutral">
                            ...
                            <Text variant="b3_regular" className="text-grey">
