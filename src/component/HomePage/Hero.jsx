...
const Hero = () => {
    return (
        <div className="relative pb-8 md:pb-26">
            <Container padding>
                <div
                    className={` bsg-[url("/images/hero.png")] bg-[linear-gradient(98.33deg,rgba(0,66,107,0.6)_5.16%,rgba(102,102,102,0)_92.95%),url('/images/hero.png')] bg-cover bg-center md:bg-center  bg-no-repeat  rounded-[2.5rem]  flex items-center px-6 md:px-16 pt-29.5 md:pt-54 pb-38.75 md:pb-44.25 text-white border border-blue-normal`}
                >
                    <div className="">
                        <img
                        ...
                        <div className="">
                            ...
                            <Text
                                ...
                                variant="b2_regular"
                            >
                                Family-owned carpet & floor cleaning in Salinas
                                delivering fast, eco-friendly results that
                                remove deep stains, eliminate odors, and leave
